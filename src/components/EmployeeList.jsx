...
const EmployeeList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: '10%',
      render: (text, record) => {
        const handleEditClick = (currentEmpData) => {
          showEdit(currentEmpData)
        }
        return (
          <Button
            type="primary"
    ...
    },
    {
      ...
      width: '10%',
      render: (text, record) => {
        const handleModalEditClick = (currentEmpData) => {
          showModalEdit(currentEmpData)
        }
        return (
          <Button
            type="primary"
            size="small"
            shape="round"
            onClick={() => handleModalEditClick(record)}
          >
            Modal Edit
          </Button>
        )
